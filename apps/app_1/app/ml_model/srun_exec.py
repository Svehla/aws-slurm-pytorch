...
# magic paths...
sys.path.append('/shared/app_1/app/ml_model')
sys.path.append('/shared/app_1/app/ml_model/src/download_multinode_dataset')
...
torchrun_cmd = ' '.join([
    ...
    # this file is run from ../ so path is nested with ./ml_model
    "./ml_model/src/main_mnist_multinode.py",
    "--total_epochs", "5",
    "--save_every", "5",
